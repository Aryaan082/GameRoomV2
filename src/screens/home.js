  ...
  return (
    <div style={{boxShadow: "0px 15px 15px #FAFAFA"}}>
      <Navbar style={{
        ...
        <Link to='/app'>
          <Button style={{borderRadius: '50px'}} variant="outline-primary">Enter App</Button>
        </Link>
      </Navbar>
    </div>
  );
    ...
    <div>
      <div style={{
        ...
        <h1 style={{
          ...
          textAlign: 'center', 
          fontSize: '50px'}}>
          <b>Playing Games With Cryptocurrency</b>
        </h1>
        <p style={{
          textAlign: 'center',
          fontSize: '20px'}}>
          <br/>
          BitGames is an open source and transparent way for anybody to learn how to use cryptocurrency and play games to win cryptocurrency.
        </p>  
      </div>
    </div>
  )
    ...
    <div>
      <div style={{paddingTop: '92px'}}>
        <div>
          <div style={{
            padding: '40px 0px',
            background: 'linear-gradient(135deg, #ff004c, #0057D9)',
            borderRadius: '10px',
            width: '800px', 
            height: '100px', 
            margin: '0 auto'}}>
        ...
        <div style={{
          ...
          paddingTop: '38px',
          paddingBottom: '65px'}}>
          <Jumbotron style={{borderRadius: '10px', padding: '40px 0px'}}>
            <Container expand='true'>
              ...
              <p style={{
                ...
                textAlign: 'center',
                fontSize: '20px'}}>
                <br />Coming Soon! Earn rewards by providing liquidity to BitGames users and increasing max bet size.
              </p>
              <br />
              <div style={{
                display: 'flex',
            ...
            <Col md={3}>
              <Card>
                <Card.Body>
                  <Card.Title><b style={{
                    fontSize: '24px',
                    color: '#0057D9'}}>Connect</b></Card.Title>
            ...
            <Col md={3}>
              <Card>
                <Card.Body>
                  <Card.Title><b style={{
                    fontSize: '24px',
                    color: '#0057D9'}}>Deposit</b></Card.Title>
                  <Card.Text style={{padding: '10px 0px'}}>
            ...
            <Col md={3}>
              <Card>
                <Card.Body>
                  <Card.Title><b style={{
                    fontSize: '24px',
                    color: '#0057D9'}}>Play</b></Card.Title>
                  <Card.Text style={{padding: '10px 0px'}}>
